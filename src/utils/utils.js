...
export function isMobileOrTablet() {
  ...
  if (!check) {
    // Extra check for iPad (which uses the same user agent as desktop Mac)
    check = /Macintosh/i.test(navigator.userAgent) && navigator.maxTouchPoints && navigator.maxTouchPoints > 1;
  }
  return check;
};